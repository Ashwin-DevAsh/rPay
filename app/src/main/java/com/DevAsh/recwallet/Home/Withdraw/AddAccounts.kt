...
class AddAccounts : AppCompatActivity() {
    ...
    private fun addAccount(it:View){
       if(!validate()){
        ...
        AndroidNetworking.post(ApiContext.profileSubDomain+"/addBankAccount")
    ...
    private fun isAccountExist():Boolean{
        val accountList: ArrayList<com.DevAsh.recwallet.Models.BankAccount>? =
            StateContext.model.bankAccounts.value ?: return false
